...
/**
 * Interface definition for a callback to be invoked when Box.publicShare() is
 * called.
 */
public interface PublicShareListener extends ResponseListener {
    
    /** Operation was successful. */
    String STATUS_SHARE_OK = "share_ok";
    ...
    String STATUS_SHARE_ERROR = "share_error"; 
    
    /**
     * Called when the API request has completed.
     * 
     * @param publicName
     *            A unique identifier of the publicly shared file. This can be
     *            used to generate shared page URLs, or null if there was an
     *            error.
     * @param status
     *            Status code from Box API
     */
    void onComplete(String publicName, String status);
}
