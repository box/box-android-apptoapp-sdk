...
/**
 * Interface definition for a callback to be invoked when Box.AddToTag() is
 * called.
 */
public interface AddToTagListener extends ResponseListener {

    /** If operation was successful. */
    String STATUS_ADDTOTAG_OK = "addtotag_ok";
    /** If operation was not successful. */
    String STATUS_ADDTOTAG_ERROR = "addtotag_error";
