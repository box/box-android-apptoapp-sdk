...
/**
 * Interface definition for a callback to be invoked when Box.setDescription()
 * is called.
 */
public interface SetDescriptionListener extends ResponseListener {
    
    /** Operation was successful. */
    String STATUS_S_SET_DESCRIPTION = "s_set_description";
    
    /** Operation was unsuccessful. */
    String STATUS_E_SET_DESCRIPTION = "e_set_description";   
