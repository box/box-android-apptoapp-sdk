...
/**
 * Interface definition for a callback to be invoked when Box.privateShare() is
 * called.
 */
public interface PrivateShareListener extends ResponseListener {

    /** Operation was successful. */
    String STATUS_PRIVATE_SHARE_OK = "private_share_ok";
    ...
    String STATUS_PRIVATE_SHARE_ERROR = "private_share_error";     
